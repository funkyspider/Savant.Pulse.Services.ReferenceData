...
namespace Pomelo.EntityFrameworkCore.MySql.Internal
{
    public class MySqlOptions : IMySqlOptions
    {
        ...
        public virtual void Validate(IDbContextOptions options)
        {
            ...
            //    throw new InvalidOperationException(
            //        CoreStrings.SingletonOptionChanged(
            //            nameof(MimerConnectionStringBuilder.TreatTinyAsBoolean),
            //            nameof(DbContextOptionsBuilder.UseInternalServiceProvider)));
            //}
            ...
            //    throw new InvalidOperationException(
            //        CoreStrings.SingletonOptionChanged(
            //            nameof(MimerConnectionStringBuilder.GuidFormat),
            //            nameof(DbContextOptionsBuilder.UseInternalServiceProvider)));
            //}
        ...
        public virtual MimerConnectionSettings ConnectionSettings { get; private set; }
