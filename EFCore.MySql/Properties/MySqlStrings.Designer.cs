...
namespace Pomelo.EntityFrameworkCore.MySql.Internal
{
    ...
    public static class MySqlStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EFCore.MySql.Properties.MySqlStrings", typeof(MySqlStrings).GetTypeInfo().Assembly);
...
namespace Pomelo.EntityFrameworkCore.MySql.Internal
{
    ...
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EFCore.MySql.Properties.MySqlStrings", typeof(MySqlResources).GetTypeInfo().Assembly);
